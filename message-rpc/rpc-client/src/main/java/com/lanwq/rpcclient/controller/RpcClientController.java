package com.lanwq.rpcclient.controller;

import com.lanwq.rpcclient.config.RabbitConfig;
...
public class RpcClientController {
    ...
    public void hello(String message) {
        ...
        if (result != null) {
            ...
            String springReturnedMessageCorrelation = (String) result.getMessageProperties().getHeaders().get("springReturnedMessageCorrelation");
