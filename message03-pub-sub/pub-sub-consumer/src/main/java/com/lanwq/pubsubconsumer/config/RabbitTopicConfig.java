...
public class RabbitTopicConfig {
    public final static String TOPIC_NAME = "sang-topic";
    ...
    /**
     *  # 是占位符，
     * 将三个 Queue 分别绑定到 TopicExchange 上，第一个 Binding 中的 “xiaomi.#” 表示消息的 routingkey 凡是以 “xiaomi” 开头的，都将被路由到名称为 “xiaomi” 的 Queue 上，
